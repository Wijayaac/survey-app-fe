  ...
  <PageComponent>
    <template v-slot:header>
      <div class="flex justify-between items-center">
        ...
        <router-link :to="{ name: 'survey-create' }" class="btn btn-green">
    ...
    <div v-else-if="Object.keys(surveys.data).length">
      ...
      <div
        ...
        v-if="Object.keys(surveys.data).length"
      >
        <nav
...
async function deleteSurvey(survey) {
  if (
    confirm(
      "Are you sure want to delete this survey ? Operation cannot be undone"
    )
  ) {
