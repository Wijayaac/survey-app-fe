			...
			<div v-if="Object.keys(data).length"
				...
				<div v-if="data.latestSurvey">
					<div class="img-container pt-[240px] w-64">
						<img :src="data.latestSurvey.image" :alt="data.latestSurvey.title" class="mx-auto">
					</div>
					...
					<div class="flex justify-between">
						<router-link :to="{name: 'SurveyView', params: { id : data.latestSurvey.id}}" class="btn btn-plain">
